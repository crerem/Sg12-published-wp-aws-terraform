...
module "storage" {
  ...
  EFS_PUBLIC_SUB_A = module.network.vpc_subnet_app_A.id
  EFS_PUBLIC_SUB_B = module.network.vpc_subnet_app_B.id
  EFS_PUBLIC_SUB_C = module.network.vpc_subnet_app_C.id
  ENV              = var.ENV
}
